            ...
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容" name="news_desc" class="layui-textarea">{{ $detail->news_desc or '' }}</textarea>
                    </div>
                </div>
        ...
        layui.use(['form', 'layer','table','layedit','upload'],
            function() {
                ...
                form.on('submit(add)', function(data) {
                    ...
                    var id = $('#hiddenId').val();
                    var data = {id:id,news_title:fields.news_title,news_desc:fields.news_desc, sort:fields.sort,news_cover:coverPic,content:fields.content};
                    $.ajax({
                        headers: {
