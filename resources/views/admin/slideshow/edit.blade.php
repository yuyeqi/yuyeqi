            ...
            <form class="layui-form">
                        ...
                        <div class="layui-upload">
                            ...
                            <div class="layui-upload-list">
                                <div id="" class="file-iteme">
                                    ...
                                    <img src="{{ $detail->slideshow_url or '' }}" style="width: 100px;height: 100px;" alt="" id="uploadPic">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容" name="description" class="layui-textarea">{{ $detail->description or '' }}</textarea>
                    </div>
                </div>
