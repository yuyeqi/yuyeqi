        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加分类','{{ route('exchangeCate_add_show') }}',500,300)"><i class="layui-icon"></i>添加</button>
                </div>
...
<script>
    ...
    layui.use(['laydate','form','table'], function(){
        ...
        table.on('tool(tableTool)', function(obj){
            var data = obj.data;
            if(obj.event === 'edit'){
                xadmin.open('编辑',"/hp/exchangeCate/editShow/"+data.id,500,300);
    ...
    function member_stop(id,status){
        ...
        layer.confirm(msg,function(index){
            $.ajax({
                ...
                type: 'post',
                url: "{{ route('exchangeCate_update_status') }}",
                dataType: 'json',
