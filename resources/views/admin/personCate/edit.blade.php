                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="cate_name" name="cate_name" required="" lay-verify="required"
                               autocomplete="off" class="layui-input" value="{{ $detail->cate_name or '' }}">
                        ...
                        <div class="layui-upload">
                            ...
                            <div class="layui-upload-list">
                                <div id="" class="file-iteme">
                                    ...
                                    <img src="{{ $detail->bg_url or '' }}" style="width: 100px;height: 100px;" alt="" id="uploadPic">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="number" id="sort" name="sort"  required="" lay-verify="sort"
                               autocomplete="off" class="layui-input" value="{{ $detail->sort or 0 }}">
                    </div>
                </div>
        ...
        layui.use(['form', 'layer','table','layedit','upload'],
            function() {
                ...
                form.on('submit(add)', function(data) {
                    ...
                    var id = $('#hiddenId').val();
                    var data = {id:id,cate_name:fields.cate_name, sort:fields.sort,bg_url:coverPic};
                    $.ajax({
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
                        type: 'POST',
                        url: '{{route('personCate_edit')}}',
                        data: data,
                        dataType: 'json',
